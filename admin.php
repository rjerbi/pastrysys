    ...
    <div class="col-md-3">
        <div class="panel panel-box clearfix">
            <div class="panel-icon pull-left bg-yellow">
                <i class="glyphicon glyphicon-list-alt"></i> <!-- You can change the icon as needed -->
            </div>
            <div class="panel-value pull-right">
                <h2 class="margin-top"> <?php echo $c_supplier['total']; ?> </h2> <!-- Assuming you have a count function for suppliers -->
                <p class="text-muted">Fournisseurs</p>
            </div>
        </div>
    </div>
  </a>
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          <span>Derniers produits ajoutés</span>
        </strong>
      </div>
      <div class="panel-body">
