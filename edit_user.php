     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          Mettre à jour votre compte, <?php echo remove_junk(ucwords($e_user['name'])); ?>
        </strong>
       </div>
            ...
            <div class="form-group">
              <label for="status">Status</label>
                <select class="form-control" name="status">
                  <option <?php if($e_user['status'] === '1') echo 'selected="selected"';?>value="1">Activé</option>
                  <option <?php if($e_user['status'] === '0') echo 'selected="selected"';?> value="0">Désactivé</option>
                </select>
            </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          Changez votre mot de passe, <?php echo remove_junk(ucwords($e_user['name'])); ?>
        </strong>
      </div>
      <div class="panel-body">
